...
<form role="form" action="{{ route('empresas.update', codifica($empresa->id)) }}" method="POST">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                <label>Nombre</label>
                <input type="text" class="form-control" name="nombre" value="{{ old('nombre', $empresa->nombre) }}" maxlength="40" required autofocus>
